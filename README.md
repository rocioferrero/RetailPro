...
El proyecto integra **SQL Server** para la creación, carga y consulta de los datos, y **Power BI** para la transformación, análisis y visualización de la información.
...
| `m4_consultas_negocio.sql`        | Contiene consultas orientadas al análisis del negocio y la obtención de indicadores.  |
...
* Power BI Desktop para visualizar y analizar los archivos `.pbix`.
